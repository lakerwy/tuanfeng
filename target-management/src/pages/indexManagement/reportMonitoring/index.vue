<template>
  ...
  <div class="content">
    ...
    <div class="content-main">
      <table-one :treeData="treeData" :options="nationOptions" ref="table"></table-one>
    </div>
  </div>
</template>
...
import TableOne from "@/pages/indexManagement/reportMonitoring/component/table";
import { getOrglist } from "@/api/orgList.js";
  ...
  methods: {
    async getOrgListData() {
      ...
      res.data.records.forEach(item=>{
        ...
        item.upDepName=item.name
        item.key = item.id;
      })
      this.treeData=setTreeData(res.data.records,'parentId');
