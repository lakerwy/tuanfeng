<template>
  <div class="table">
    ...
    <div class="table-main">
      ...
      >
        <template slot="status" slot-scope="text">
         ...
         <template slot="operation" slot-scope="text, record">
          ...
          >
            <a href="javascript:;"
              ><a-icon title="删除" type="delete" style="margin-left:10px;font-size:20px"
            /></a>
          </a-popconfirm>
        </template>
      </a-table>
     ...
     <!-- 新增 -->
    <div>
      <dialog-add :treeData="treeData" :options="options" ref="add"></dialog-add>
    </div>
        <!-- 编辑 -->
    <div>
      <dialog-one :treeData="treeData" ref="dialogValue" :options="options" :form="form"></dialog-one>
    </div>
  </div>
</template>
...
export default {
  components: {dialogAdd,dialogOne},
    ...
    return {
      ...
      columns: [
        ...
        },
        {
          title: "上报科室",
          dataIndex: "upDepName",
          scopedSlots: { customRender: "upDepName" },
          // width: 120,
          align: "center"
        },
        {
          title: "上报人",
          dataIndex: "upPerson",
          scopedSlots: { customRender: "upPerson" },
          // width: 220,
          align: "center",
          ellipsis: true
        },
