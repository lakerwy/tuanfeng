  ...
  methods: {
    async meatData() {
      ...
      if (this.kpiData.useType == null) {
        ...
        this.glTree = this.kpiData.useType.split(",");
        console.log(this.kpiData.useType);
       ...
       this.glTree = this.glTree.filter(function(value){
        ...
        //   let indexNumber = this.glTree.indexOf('0');
        // if(indexNumber!=-1)
        // this.glTree.splice(0);
      //  for(let j in this.faTree){
      //   for(let i=0;i<this.glTree.length;i++){
          
      //     if(this.glTree[i] != 0){
      //     this.faTree[j]=this.glTree[i]
      //     // this.glTree.splice(i,1)
      //     }
      //   }}
