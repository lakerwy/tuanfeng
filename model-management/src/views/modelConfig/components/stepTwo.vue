  ...
  <div class="step">
    <div class="configContainer">
      <div class="header">
        ...
        <div class="title">步骤二：选择评价参数</div>
      </div>
      <div class="content">
        <template v-if="data">
...
import { saveModelStepSecondRequest } from "@/api/modelConfigApi";
...
export default {
  ...
  methods: {
    init(id, data) {
      this.modelId = id;
      this.data = data?.modelSplitrules;
    },
    async save() {
      let list = [];
      ...
      let res = await saveModelStepSecondRequest(data);
