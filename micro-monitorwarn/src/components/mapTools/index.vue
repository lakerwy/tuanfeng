  ...
  <div class="map-tools">
    <div>
      <div class="tool" v-for="i in toolLists" :key="i.title" @click="handleToolClick(i.type)">
        <a-tooltip placement="left" class="item" effect="dark">
          <template slot="title">
            <span>{{i.title}}</span>
          </template>
      ...
      <!-- <div class="tool" @click="handleToolClick('layer')">
        <a-tooltip class="item" effect="dark" content="图层" placement="left">
          <img src="../../assets/images/layer.png" alt="图层">
        </a-tooltip>
      </div> -->

      <div class="tool image"  @click="handleToolClick('imageLayer')">
        <a-tooltip placement="left" class="item" effect="dark" content="切换影像图层" v-if="showXyLayer">
          <template slot="title">
            <span>切换影像图层</span>
          </template>
          <img src="../../assets/images/icon-yx.png" alt="影像图层">
        </a-tooltip>
        <a-tooltip placement="left" class="item" effect="dark" content="切换矢量图层"  v-else>
          <template slot="title">
            <span>切换矢量图层</span>
          </template>
          <img src="../../assets/images/icon-sl-big.png" alt="矢量图层">
        </a-tooltip>
      </div>
    </div>
...
export default {
  data() {
    return {
      toolLists: [
        // {title: '抓手', img: require('../../assets/images/hand.png'), type: 'drag'},
        {title: '放大', img: require('../../assets/images/zoom-in.png'), type: 'zoomIn'},
        {title: '縮小', img: require('../../assets/images/zoom-out.png'), type: 'zoomOut'},
        {title: '全屏', img: require('../../assets/images/full-screen.png'), type: 'fullScreen'},
        {title: '测距', img: require('../../assets/images/measure.png'), type: 'measure'},
        {title: '测面', img: require('../../assets/images/icon-cm.png'), type: 'area'},
        {title: '清除', img: require('../../assets/images/clear.png'), type: 'clear'},
        // {title: '图层', img: require('../../assets/images/layer.png'), type: 'layer'},
        // {title: '切换影像图层', img: require('../../assets/images/icon-yx.png'), type: 'change'},
        // {title: '切换矢量图层', img: require('../../assets/images/icon-sl-big.png'), type: 'change'},
      ],
      type: '',
      checkLayer: ['0'],
      showLayerBox: false,
    ...
    handleToolClick(type) {
      ...
      switch(type) {
        ...
        case 'imageLayer':
          ...
          this.$emit('cahngeBaseLayers', current);
          break;
        default:
          break;
      }
