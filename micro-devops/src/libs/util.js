...
export const getTagNavListFromLocalstorage = () => {
  ...
  // const list = localStorage.tagNaveList
  // const tagList = list ? JSON.parse(list) : []
  // let allmenuName = JSON.parse(sessionStorage.getItem('allmenuName'))
  // if (allmenuName && allmenuName.length == 0) {
  //   return tagList[0]
  // } else {
  //   for (let index = 0; index < tagList.length; index++) {
  //     if ((tagList[index].name !== 'index') && !tagList[index].name.includes(allmenuName)) {
...
export const removeTreeData = (arr, id) => {
