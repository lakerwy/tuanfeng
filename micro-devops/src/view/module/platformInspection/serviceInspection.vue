<!--
 * @Author: 任继民
 * @Date: 2020-10-29 10:28:31
 * @LastEditors: 任继民
 * @LastEditTime: 2020-12-21 14:38:50
 * @Description:
-->
<template>
  <div class="inspection">
    <HeaderContent :headHeight='"54px"'/>
    <div class="div-flex">
      <div class="content">
...
import { getServicesInfo } from '@/api/serviceInspection'
export default {
  components: {
    HeaderContent
  },
  ...
  methods: {
    async iniData() {
      let res = await getServicesInfo();
      const { success, body } = res;
      if (success) {
        this.cpuInfo = body.cpu;
        this.jvmInfo = body.jvm;
        this.memInfo = body.mem;
        this.sysInfo = body.sys;
      }
    }
  },
}
