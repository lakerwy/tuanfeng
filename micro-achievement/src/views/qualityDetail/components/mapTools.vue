<template>
  <div class="map-tools">
    <div>
      <div
        class="tool"
        v-for="i in toolLists"
        :key="i.title"
        @click="handleToolClick(i.type)"
      >
        <el-tooltip
          class="item"
          effect="dark"
      ...
      <!-- <div class="tool" @click="handleToolClick('layer')">
        <el-tooltip class="item" effect="dark" content="图层" placement="right">
...
import { measureEvent } from "@/mapjs/tool/measure";
export default {
  data() {
    return {
      toolLists: [
        ...
        {
          title: "放大",
          img: require("../../../assets/imgs/zoom-in.png"),
          type: "zoomIn"
        },
        {
          title: "縮小",
          img: require("../../../assets/imgs/zoom-out.png"),
          type: "zoomOut"
        },
        {
          title: "全屏",
          img: require("../../../assets/imgs/full-screen.png"),
          type: "fullScreen"
        },
    ...
    handleToolClick(type) {
      ...
      switch (type) {
        ...
        case "imageLayer":
          ...
          // showXyLayer展示影像
          let current = this.showXyLayer
            ? window.globalUrl.vectorLayer
            : window.globalUrl.imageLayer;
