<template>
  ...
  <div class="audit-task-tree">
    <!-- <div class="p-top">
      ...
      <!-- <div class="query">
        <el-input v-model="keyword" placeholder="国土空间总体规划成果">
          <i slot="prefix">
            <img
        ...
        <el-button style="width: 90px;border-radius: 0;" type="primary"
          >搜索</el-button
        >
      </div> -->
    <!-- </div> -->
      ...
      <div class="left">
        ...
        <div class="tree">
          <div class="tree-query">
            ...
            <el-button  style="margin-left:15px" @click="resetQuery">重置</el-button>
          </div>
          <div class="version">
      ...
      <div class="right">
        <div class="nav">
          ...
          <div class="btn">
            ...
            <el-button icon="el-icon-download" v-if="rowData.approveStatus!=2" type="primary" style="width: 127px;height: 36px;padding: 0;" @click="showReport">
...
export default {
  ...
  created() {
    // console.log(this.getCurrentTab, "currentTab");
    this.TreeData();
  },
  mounted() {},
  watch: {
