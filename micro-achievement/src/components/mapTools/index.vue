  ...
  <div class="map-tools">
    <div>
      <div class="tool" v-for="i in toolLists" :key="i.title" @click="handleToolClick(i.type)">
        <el-tooltip class="item" effect="dark" :content="i.title" placement="left">
      ...
      <div class="tool image"  @click="handleToolClick('imageLayer')">
        <el-tooltip class="item" effect="dark" content="切换矢量图层" placement="left" v-if="showXyLayer">
          <img src="../../assets/imgs/icon-sl-big.png" alt="矢量图层">
        </el-tooltip>
        <el-tooltip class="item" effect="dark" content="切换影像图层" placement="left" v-else>
