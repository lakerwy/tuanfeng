<template>
  ...
  <div class="quality-detail-left">
    <div class="title">
      <el-radio v-model="radio" label="1">成果完整性检查</el-radio>
    </div>
    <div class="content">
      <el-form
        label-width="120px"
...
export default {
  ...
  mounted() {
    if (
      this.$parent.approveReqList[6].status == 0 ||
      this.$parent.approveReqList[6].status == 1
    ) {
      this.form.fileList = this.$parent.fileList6;
      this.form.status = this.$parent.approveReqList[6].status;
      this.form.remarks = this.$parent.approveReqList[6].remarks;
      this.form.attachmentDescription = this.$parent.approveReqList[6].attachmentDescription;
    }
  },
  methods: {
    handleChange(file) {
    ...
    uploadChange(file, fileList) {
      ...
      this.$parent.fileList6 = fileList;
    ...
    async getUploadList() {
      ...
      this.$parent.approveReqList[6].attachmentId = this.form.attachmentId;
    ...
    handleClickPass() {
      this.$refs.ruleForm.validate(valid => {
        if (valid) {
          this.$parent.approveReqList[6].status = 1;
          this.$parent.approveReqList[6].remarks = this.form.remarks;
          this.$parent.approveReqList[6].attachmentDescription = this.form.attachmentDescription;
          // console.log(this.$parent.approveReqList[6]);
          this.isBtn = false;
          this.isPass = true;
        } else {
