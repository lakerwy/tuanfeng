 ...
 * @LastEditors: 任继民
 * @LastEditTime: 2020-12-24 16:04:03
 * @Description:
-->
<template>
	<div class="itemTree">
		<a-tree :checkable="checkable" :default-expanded-keys="defaultExpandedKeys" :show-line="showLine" :replaceFields="defaultProps" :tree-data="data" :show-icon="showIcon" @select="onSelect" @check="onCheck" :blockNode="true" :load-data="onLoadData" >
		</a-tree>
	</div>
</template>
...
export default {
  ...
  methods: {
    ...
    // onLoadData(treeNode) {
    //   this.$emit('onLoadTreeData',treeNode);
    // },
  }
}
</script>
